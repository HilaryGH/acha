  ...
  return (
    <div className="sticky top-0 z-50">
      ...
      <nav className="w-full bg-blue-50 shadow-sm border-b border-gray-100">
        ...
        <div className={`fixed top-0 left-0 h-full w-[85%] max-w-sm bg-blue-50 text-gray-900 shadow-2xl z-50 md:hidden transform transition-transform duration-300 ease-in-out ${
          isMenuOpen ? 'translate-x-0' : '-translate-x-full'
        }`}>
          <div className="flex flex-col h-full overflow-hidden">
            {/* Mobile Menu Header */}
            <div className="relative bg-blue-50 p-5 shadow-sm flex-shrink-0 border-b border-gray-200">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 bg-white rounded-lg flex items-center justify-center shadow-sm ring-1 ring-gray-200">
                    <img 
                      src="/acha.png" 
                      alt="Acha Logo" 
                  ...
                  <div className="flex flex-col">
                    <span className="text-gray-900 font-semibold text-base leading-tight">Acha Delivery</span>
                    <span className="text-gray-600 text-xs leading-tight">አቻ ደሊቨሪ</span>
                  </div>
                </div>
                <button 
                  onClick={toggleMenu}
                  className="p-2 hover:bg-gray-100 rounded-xl transition-all duration-300 text-gray-700 hover:scale-110 active:scale-95"
            ...
            {/* Mobile Menu Links - Professional styling with proper spacing */}
            <div className="flex flex-col flex-1 py-4 px-4 gap-2 overflow-y-auto">
              <Link 
                to="/" 
                className="group flex items-center gap-3 px-4 py-3 rounded-lg transition-all duration-200 hover:bg-white hover:shadow-sm border border-transparent hover:border-gray-200"
                onClick={() => setIsMenuOpen(false)}
              >
                <div className="w-9 h-9 rounded-lg flex items-center justify-center text-gray-600 group-hover:text-green-600 transition-all duration-200 flex-shrink-0 bg-white border border-gray-200 group-hover:border-green-200">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                  </svg>
                </div>
                <span className="text-gray-700 font-medium text-base flex-1 group-hover:text-gray-900">{t('navbar.home')}</span>
                <svg className="w-5 h-5 text-gray-400 group-hover:text-green-600 transition-colors duration-200 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              >
                ...
                <span className="text-gray-700 font-medium text-base flex-1 group-hover:text-gray-900">{t('navbar.postTrip')}</span>
                <svg className="w-5 h-5 text-gray-400 group-hover:text-green-600 transition-colors duration-200 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                </svg>
              </Link>
              ...
              >
                ...
                <span className="text-gray-700 font-medium text-base flex-1 group-hover:text-gray-900">{t('navbar.postOrder')}</span>
                <svg className="w-5 h-5 text-gray-400 group-hover:text-green-600 transition-colors duration-200 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                </svg>
              </Link>
              ...
              >
                ...
                <span className="text-gray-700 font-medium text-base flex-1 group-hover:text-gray-900">{t('navbar.findDelivery')}</span>
                <svg className="w-5 h-5 text-gray-400 group-hover:text-green-600 transition-colors duration-200 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                </svg>
              </Link>
              ...
              >
                ...
                <span className="text-gray-700 font-medium text-base flex-1 group-hover:text-gray-900">{t('navbar.about')}</span>
                <svg className="w-5 h-5 text-gray-400 group-hover:text-green-600 transition-colors duration-200 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                </svg>
              </Link>
              ...
              {isLoggedIn ? (
                <>
                  ...
                  >
                    ...
                    <span className="text-gray-700 font-medium text-base flex-1 group-hover:text-gray-900">{t('navbar.dashboard')}</span>
                    <svg className="w-5 h-5 text-gray-400 group-hover:text-green-600 transition-colors duration-200 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                    </svg>
                  </Link>
                  <button
                    ...
                    className="group flex items-center gap-3 px-4 py-3 rounded-lg transition-all duration-200 hover:bg-white hover:shadow-sm border border-transparent hover:border-gray-200"
                  >
                    <div className="w-9 h-9 rounded-lg flex items-center justify-center text-gray-600 group-hover:text-red-600 transition-all duration-200 flex-shrink-0 bg-white border border-gray-200 group-hover:border-red-200">
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
                      </svg>
                    </div>
                    <span className="text-gray-700 font-medium text-base flex-1 group-hover:text-gray-900">{t('navbar.logout')}</span>
                    <svg className="w-5 h-5 text-gray-400 group-hover:text-red-600 transition-colors duration-200 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                    </svg>
                  </button>
                </>
                ...
                >
                  ...
                  <span className="text-gray-700 font-medium text-base flex-1 group-hover:text-gray-900">{t('navbar.login')}</span>
                  <svg className="w-5 h-5 text-gray-400 group-hover:text-green-600 transition-colors duration-200 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                  </svg>
                </button>
            ...
            <div className="px-4 py-3 border-t border-gray-200 bg-blue-50 flex-shrink-0">
              <div className="flex items-center justify-center gap-3">
                {/* X (Twitter) */}
                <a href="#" className="w-9 h-9 flex items-center justify-center bg-white hover:bg-gray-50 text-gray-600 hover:text-gray-900 rounded-lg transition-all duration-300 shadow-sm border border-gray-200" aria-label="X (Twitter)" onClick={() => setIsMenuOpen(false)}>
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                  </svg>
                </a>
                {/* TikTok */}
                <a href="#" className="w-9 h-9 flex items-center justify-center bg-white hover:bg-gray-50 text-gray-600 hover:text-gray-900 rounded-lg transition-all duration-300 shadow-sm border border-gray-200" aria-label="TikTok" onClick={() => setIsMenuOpen(false)}>
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5 20.1a6.34 6.34 0 0 0 10.86-4.43v-7a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1-.1z"/>
                  </svg>
                </a>
                {/* LinkedIn */}
                <a href="#" className="w-9 h-9 flex items-center justify-center bg-white hover:bg-gray-50 text-gray-600 hover:text-gray-900 rounded-lg transition-all duration-300 shadow-sm border border-gray-200" aria-label="LinkedIn" onClick={() => setIsMenuOpen(false)}>
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                  </svg>
                </a>
                {/* Facebook */}
                <a href="#" className="w-9 h-9 flex items-center justify-center bg-white hover:bg-gray-50 text-gray-600 hover:text-gray-900 rounded-lg transition-all duration-300 shadow-sm border border-gray-200" aria-label="Facebook" onClick={() => setIsMenuOpen(false)}>
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                  </svg>
                </a>
                {/* Instagram */}
                <a href="#" className="w-9 h-9 flex items-center justify-center bg-white hover:bg-gray-50 text-gray-600 hover:text-gray-900 rounded-lg transition-all duration-300 shadow-sm border border-gray-200" aria-label="Instagram" onClick={() => setIsMenuOpen(false)}>
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="p-4 border-t border-gray-200 bg-blue-50 flex-shrink-0">
              {isLoggedIn ? (
                <Link
                  to="/dashboard"
                  className="block w-full text-center border border-gray-300 hover:border-green-500 text-gray-700 hover:text-white px-6 py-3.5 rounded-xl font-semibold text-base transition-all duration-300 hover:shadow-md active:scale-[0.98] flex items-center justify-center gap-2"
                  style={{ 
                ...
                <button 
                  className="w-full border border-gray-300 hover:border-green-500 text-gray-700 hover:text-white px-6 py-3.5 rounded-xl font-semibold text-base transition-all duration-300 hover:shadow-md active:scale-[0.98] flex items-center justify-center gap-2"
                  style={{ 
                    background: 'linear-gradient(135deg, transparent 0%, transparent 100%)',
                  }}
                  onMouseEnter={(e) => {
